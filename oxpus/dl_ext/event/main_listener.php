	...
	public function add_user_profile_traffic($event)
	{
		if (!$this->config['dl_traffic_off'])
		{
			...
			$this->template->assign_block_vars('custom_fields', array(
				'PROFILE_FIELD_NAME'	=> $this->user->lang['DOWNLOADS'] . ' ' . $this->user->lang['TRAFFIC'],
